...
class Calendar
{
    ...
    public function showCalendarTag($m, $y)
    {
        ...
        $this->html = <<< EOS
        <h1>
            <a class="btn btn-primary" href="/index/?year={$prev_year}&month={$prev_month}" role="button">&lt;前月</a>
            {$year}年{$month}月
            <a class="btn btn-primary" href="/index/?year={$next_year}&month={$next_month}" role="button">翌月&gt;</a>
        </h1>
